...
"use strict";angular.module("ngGeolocation",[]).factory("$geolocation",["$rootScope","$window","$q",function(o,t,i){function n(){return"geolocation"in t.navigator}var e={getCurrentPosition:function(e){var r=i.defer();return n()?t.navigator.geolocation.getCurrentPosition(function(t){o.$apply(function(){r.resolve(t)})},function(t){o.$apply(function(){r.reject({error:t})})},e):r.reject({error:{code:2,message:"This web browser does not support HTML5 Geolocation"}}),r.promise},watchPosition:function(i){n()?this.watchId||(this.watchId=t.navigator.geolocation.watchPosition(function(t){o.$apply(function(){e.position.coords=t.coords,e.position.timestamp=t.timestamp,delete e.position.error,o.$broadcast("$geolocation.position.changed",t)})},function(t){o.$apply(function(){e.position.error=t,delete e.position.coords,delete e.position.timestamp,o.$broadcast("$geolocation.position.error",t)})},i)):e.position={error:{code:2,message:"This web browser does not support HTML5 Geolocation"}}},clearWatch:function(){this.watchId&&(t.navigator.geolocation.clearWatch(this.watchId),delete this.watchId)},position:{}};return e}]);
"use strict";angular.module("ngGeolocation",[]).factory("$geolocation",["$rootScope","$window","$q",function(o,t,i){function n(){return"geolocation"in t.navigator}var e={getCurrentPosition:function(e){var r=i.defer();return n()?t.navigator.geolocation.getCurrentPosition(function(t){o.$apply(function(){r.resolve(t)})},function(t){o.$apply(function(){r.reject({error:t})})},e):r.reject({error:{code:2,message:"This web browser does not support HTML5 Geolocation"}}),r.promise},watchPosition:function(i){n()?this.watchId||(this.watchId=t.navigator.geolocation.watchPosition(function(t){o.$apply(function(){e.position.coords=t.coords,e.position.timestamp=t.timestamp,delete e.position.error,o.$broadcast("$geolocation.position.changed",t)})},function(t){o.$apply(function(){e.position.error=t,delete e.position.coords,delete e.position.timestamp,o.$broadcast("$geolocation.position.error",t)})},i)):e.position={error:{code:2,message:"This web browser does not support HTML5 Geolocation"}}},clearWatch:function(){this.watchId&&(t.navigator.geolocation.clearWatch(this.watchId),delete this.watchId)},position:{}};return e}]);
!function(){"use strict";angular.module("gps-tracking",["google-maps"])}();
!function(){"use strict";angular.module("gps-tracking").controller("MapController",["$scope","map","socket","users",function(o,r,s,e){o.users=e,o.map=r}])}();
!function(){"use strict";angular.module("gps-tracking").value("map",{center:{latitude:0,longitude:0},zoom:8}).factory("socket",function(){return io.connect("http:localhost:8000")}).value("users",{pos:{longitude:0,latitude:0}})}();